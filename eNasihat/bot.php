        ...
        <div class="form">
            <div class="bot-inbox inbox">
                ...
                <div class="msg-header">
                    <p>Hi! Bagaimana perasaan anda hari ini?</p>
                </div>
            </div>
        </div>
        <div class="typing-field">
            <div class="input-data">
                <input id="data" type="text" placeholder="Tulis mesej disini.." required>
